...
class Offset(AliasMixin, int, enum.Enum):
    ...
    MEASURES_0 = TOKEN_OFFSET.NUM_MEASURES.value
    MEASURES_2 = TOKEN_OFFSET.NUM_MEASURES.value + 1
    MEASURES_4 = TOKEN_OFFSET.NUM_MEASURES.value + 2
    MEASURES_8 = TOKEN_OFFSET.NUM_MEASURES.value + 3
    MEASURES_16 = TOKEN_OFFSET.NUM_MEASURES.value + 4
    MEASURES_24 = TOKEN_OFFSET.NUM_MEASURES.value + 5
...
def encode_num_measures(num_measures: Union[float, str]) -> int:
    ...
    if num_measures >= 0 and num_measures < 2:
        return Offset.MEASURES_0.value
    elif num_measures >= 2 and num_measures < 4:
        return Offset.MEASURES_2.value
    elif num_measures >= 4 and num_measures < 8:
        return Offset.MEASURES_4.value
    elif num_measures >= 8 and num_measures < 16:
        return Offset.MEASURES_8.value
    elif num_measures >= 16 and num_measures < 24:
        return Offset.MEASURES_16.value
    elif num_measures >= 24 and num_measures < 48:
        return Offset.MEASURES_24.value
    else:
